  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-xl h-auto bg-white rounded-lg border-8 border-teal-500 shadow-md">
            ...
            <div className="border-4 border-teal-500 rounded-lg m-6">
              <div className="border-2 border-slate-500 rounded-lg m-1">
                <div className="flex flex-col items-center p-10">
                  ...
                  <span className="text-lg text-gray-500">with</span>
                  <h3 className="mb-1 text-lg font-medium text-gray-900">
                    {response.result[2]} Grade.
                  </h3>
                </div>
